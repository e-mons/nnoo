...
import { createCatalogItemSchema } from '@nnoo/validation';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from('catalog_items').insert({
        ...
        currency_code: (activeBusiness as any)?.currency_code || 'NGN',
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View>
              <Text style={styles.headerTitle}>Add Catalog Item</Text>
              <Text style={styles.subtext}>Product or billable service</Text>
            </View>
          </View>
            ...
            <View style={styles.typeButtonsRow}>
              ...
              >
                <Feather
                  name="package"
                  size={16}
                  color={itemType === 'product' ? '#0A1C16' : '#FFF'}
                />
                <Text
                  style={[
                    styles.typeButtonText,
                    itemType === 'product' && styles.typeButtonTextActive,
                  ]}
                >
                  Physical Product
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.typeButton,
                  itemType === 'service' && styles.typeButtonActive,
                ]}
              ...
              >
                <Feather
                  name="tool"
                  size={16}
                  color={itemType === 'service' ? '#0A1C16' : '#FFF'}
                />
                <Text
                  style={[
                    styles.typeButtonText,
                    itemType === 'service' && styles.typeButtonTextActive,
                  ]}
                >
                  Billable Service
                </Text>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputBox, errors.name ? styles.inputBoxError : null]}>
                <TextInput
                  style={styles.input}
                  placeholder={itemType === 'product' ? 'e.g. 500ml Bottled Water' : 'e.g. Graphic Design Consultation'}
