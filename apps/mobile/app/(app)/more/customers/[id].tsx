...
const styles = StyleSheet.create({
  ...
  receivablesLabel: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontWeight: '600', marginBottom: 2 },
  receivablesAmount: { fontSize: 20, fontWeight: '900', color: '#FF9800' },
  newInvoiceBtn: {
  ...
  newInvoiceBtnText: { color: '#0A1C16', fontWeight: '900', fontSize: 12 },
  ...
  cardTitle: { fontSize: 15, fontWeight: '800', color: '#FFF', marginBottom: 10 },
  cardHeaderRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  headerActionText: { color: '#B8F25C', fontWeight: '800', fontSize: 13 },
