...
export default function CustomersIndexScreen() {
  ...
  const [filter, setFilter] = useState<'all' | 'individual' | 'business' | 'active'>('all');
  ...
  const filteredCustomers = customers.filter((c) => {
    if (filter === 'individual') return c.customer_type === 'individual';
    if (filter === 'business') return c.customer_type === 'business';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.subtext}>Client directory and accounts</Text>
        </View>
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              <Feather name="users" size={36} color="rgba(255,255,255,0.2)" />
              <Text style={styles.emptyText}>No customers found.</Text>
              <Text style={styles.emptySubtext}>
                Tap the + button to add a new customer to your directory.
              </Text>
            </View>
          }
        />
...
const styles = StyleSheet.create({
  ...
  customerName: { fontSize: 16, fontWeight: '800', color: '#FFF' },
