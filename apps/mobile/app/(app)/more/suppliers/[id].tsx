...
const styles = StyleSheet.create({
  ...
  payableCardLabel: { fontSize: 12, color: 'rgba(255,255,255,0.7)', fontWeight: '600' },
  payableCardAmount: { fontSize: 22, fontWeight: '900', color: '#FF9800', marginTop: 2 },
  payablesLinkBtn: {
  ...
  payablesLinkText: { color: '#FF9800', fontWeight: '800', fontSize: 12 },
  ...
  notesText: { fontSize: 14, color: 'rgba(255,255,255,0.7)', lineHeight: 20 },
  ...
  historyNumber: { fontSize: 14, fontWeight: '800', color: '#FFF' },
  historyDate: { fontSize: 11, color: 'rgba(255,255,255,0.45)', marginTop: 2 },
  historyAmount: { fontSize: 14, fontWeight: '900', color: '#B8F25C' },

  bottomActions: { flexDirection: 'row', gap: 12, marginTop: 4, marginBottom: 40 },
  actionLinkBtn: {
    flex: 1,
  ...
  actionLinkBtnText: { color: '#0A1C16', fontWeight: '900', fontSize: 14 },
