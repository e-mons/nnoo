...
export default async function BusinessHealthScorePage({ params }: HealthScorePageProps) {
  ...
  // Check role authorization: Health Score requires full financial visibility
